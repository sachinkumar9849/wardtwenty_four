...
<head>
  ...
  <meta name="description" content="Buy, sell and rent land, houses and commercial property in Nepal. Yadukul offers land plotting, turnkey construction, architectural and structural engineering and property consultancy.">
  <meta name="author" content="Yadukul Real Estate &amp; Construction Pvt. Ltd.">
  <meta name="theme-color" content="#1F2937">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Yadukul Real Estate &amp; Construction | Property, Land &amp; Building in Nepal">
  <meta property="og:description" content="Buy, sell and rent land, houses and commercial property in Nepal. Yadukul offers land plotting, turnkey construction, architectural and structural engineering and property consultancy.">
        ...
        <div class="search-card">
          ...
          <form id="propertySearch" novalidate>
            <div class="row g-3 align-items-end">
              ...
              <div class="col-lg col-md-6">
                <label class="field-label" for="s-price">Budget</label>
              ...
              <div class="col-lg-auto col-12">
                <button type="submit" class="btn btn-accent w-100">
                  <i class="bi bi-search me-2" aria-hidden="true"></i>Search Property
                </button>
              </div>
